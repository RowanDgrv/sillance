...
(function(){
  var fr = {
    "payReturn.titleSuccess": `Paiement confirmé`,
    "payReturn.titleCancel": `Paiement annulé`,
    "payReturn.continue": `Continuer`,
    "payReturn.checkout.success": `Ton abonnement Coach est actif. Bienvenue.`,
    "payReturn.checkout.cancel": `Le paiement a été annulé, ton abonnement n'a pas changé.`,
    "payReturn.ai.success": `L'Assistant IA est activé sur ton compte.`,
    "payReturn.ai.cancel": `L'activation de l'Assistant IA a été annulée.`,
    "payReturn.coaching.success": `Ton abonnement de coaching est actif.`,
    "payReturn.coaching.cancel": `L'abonnement de coaching n'a pas été activé.`,
    "payReturn.clubSub.success": `L'abonnement du club à Sillance est actif.`,
    "payReturn.clubSub.cancel": `L'abonnement du club n'a pas été activé.`,
    "payReturn.videos.success": `L'accès vidéos a été mis à jour pour tes athlètes.`,
    "payReturn.videos.cancel": `La mise à jour de l'accès vidéos a été annulée.`,
    "payReturn.creneau.success": `Ta place est réservée, le paiement est confirmé.`,
    "payReturn.creneau.cancel": `La réservation n'a pas été confirmée, le paiement a été annulé.`,
    "payReturn.coachConnect.success": `Ton compte Stripe est relié. Tu peux désormais te faire payer par tes athlètes.`,
    "payReturn.coachConnect.cancel": `La mise en relation avec Stripe n'est pas terminée. Réessaie quand tu veux depuis la bannière « Fais-toi payer ».`,
    "payReturn.clubConnect.success": `Le compte Stripe du club est relié. Les paiements des adhérents peuvent être encaissés.`,
    "payReturn.clubConnect.cancel": `La mise en relation avec Stripe n'est pas terminée pour le club. Réessaie depuis les réglages de facturation.`,
    "payReturn.premium.success": `Sillance Premium Club est actif : l'Assistant IA et la bibliothèque sont débloqués pour le staff du club.`,
    "payReturn.premium.cancel": `L'abonnement Sillance Premium Club n'a pas été activé.`,
    ...
    "toast.selfCoachEnabled": `Auto-coaching activé · bascule sur l'onglet Athlète pour gérer ton entraînement.`,
    "toast.selfCoachError": `Impossible d'activer l'auto-coaching, réessaie.`,
    "toast.assistantIaActiveEssai14": `Assistant IA activé · essai 14 jours (démo)`,
    "toast.athleteNotifiedReady": `{name} a été prévenu·e que sa semaine est prête`,
    ...
    "deviceReturn.connectedZero": `{provider} connecté.`,
    "deviceReturn.connectedSingular": `{provider} connecté, {n} activité importée.`,
    "deviceReturn.connectedPlural": `{provider} connecté, {n} activités importées.`,
    "deviceReturn.error": `La connexion a échoué. Réessaie depuis la carte Synchronisation.`,
    ...
    "ready.recoveryReady": `Prêt pour un effort dur maintenant`,
    "ready.recoveryIn": `Effort dur possible dans {time}`,
    "ready.recoveryHours": `{h} h`, "ready.recoveryDays": `{d} j`, "ready.recoveryDaysHours": `{d} j {h} h`,
    "predict.heading": `Prédicteur de course`, "predict.sub": `estimé à partir de l'allure seuil et de la forme du moment`,
    "predict.half": `Semi`, "predict.marathon": `Marathon`,
    "mono.heading": `Monotonie & Strain`, "mono.sub": `variabilité de la charge sur 7 jours (méthode Foster)`,
    "mono.high": `Élevée`, "mono.ok": `Correcte`,
    "mono.strainNote": `Strain hebdo ≈ {strain} · une monotonie élevée (≥2) signale une charge stable sans vraie récupération, même quand l'ACWR paraît correct.`,
    "block.heading": `Historique bloc à bloc`, "block.sub": `charge hebdo moyenne, périodes comparées`,
    "block.prev12": `12 sem. précédentes`, "block.last4": `4 dernières sem.`, "block.avgLoadWeek": `charge/sem.`,
    "dash.widgetsHeading": `Widgets affichés`, "dash.widgetsSub": `Choisis ce qui apparaît sur ta sidebar coach et ton tableau de forme.`,
    "dash.widgetNeedRadar": `Qui a besoin de toi cette semaine`, "dash.widgetPlanningRadar": `Rappel de planification`,
    "dash.widgetReadyhub": `État de forme & risque`, "dash.widgetAdvanced": `Charge avancée (prédicteur, monotonie, blocs)`,
    "dash.widgetNutritionToday": `Nutrition recommandée (Ton point du jour) — utilise ta consigne « pendant l'effort »`,
    "dash.alertsHeading": `Alertes personnalisées`, "dash.alertsSub": `Définis tes propres seuils : dépassés, l'athlète remonte dans le radar « qui a besoin de toi ».`,
    "dash.noAlerts": `Aucune alerte personnalisée pour l'instant.`, "dash.threshold": `Seuil`,
    "dash.addAlert": `+ Ajouter`, "dash.thresholdRequired": `Renseigne un seuil.`, "dash.alertAdded": `Alerte ajoutée.`,
    "clubFilter.allSports": `Tous sports`, "clubFilter.allGroups": `Tous groupes`, "clubFilter.allLevels": `Tous niveaux`,
    "level.debutant": `Débutant`, "level.confirme": `Confirmé`, "level.competition": `Compétition`,
    "season.title": `Calendrier de saison`, "season.btn": `Saison`, "season.add": `+ Ajouter`,
    "season.empty": `Aucune course enregistrée pour l'instant.`, "season.addResult": `+ ajouter le résultat`,
    "season.resultFor": `Résultat — {name}`, "season.fillNameDate": `Renseigne au moins le nom et la date.`, "season.added": `Course ajoutée au calendrier.`,
    "season.saveError": `Impossible d'enregistrer la course, réessaie.`, "season.myRaces": `Mes courses`, "season.openMine": `Voir mon calendrier de saison`,
    "compareAth.btn": `Comparer 2 athlètes`, "compareAth.title": `Comparer deux athlètes`,
    "compareAth.forme": `Forme (check-in)`, "compareAth.hrv": `HRV`, "compareAth.drop": `Découplage`, "compareAth.racedays": `Jours avant course`,
    "compareAth.pickTwo": `Choisis deux athlètes différents pour comparer.`, "compareAth.noData": `Pas encore de données comparables pour ces deux athlètes.`,
    "recap.title": `Analyse de course`, "recap.typeRun": `Course à pied`, "recap.typeTri": `Triathlon`, "recap.typeHyrox": `Hyrox`,
    "recap.editLink": `Modifier l'analyse`, "recap.addLink": `+ Analyse de course`,
    "recap.totalTime": `Temps total`, "recap.avgPace": `Allure moy.`, "recap.avgHr": `FC moy.`,
    ...
    "recap.raceInfo": `Classement & conditions`, "recap.rankScratch": `Scratch`, "recap.rankTotal": `Sur`,
    "recap.rankCat": `Rang cat.`, "recap.catLabel": `Catégorie`, "recap.temp": `Température (°C)`,
    "recap.wind": `Vent (km/h)`, "recap.dplusBike": `D+ vélo (m)`, "recap.dplusRun": `D+ course (m)`,
    "recap.preRaceNutrition": `Avant-course`, "recap.carbs": `Glucides (g)`, "recap.liquid": `Liquide (L)`,
    "recap.note": `Note`, "recap.notePh": `Ressenti, tolérance digestive…`, "recap.pace100": `Allure /100m`,
    "recap.nutritionNote": `Nutrition`, "recap.hrMax": `FC max`,
    "recap.editView": `Saisie`, "recap.cockpitView": `Fiche`, "recap.compareTitle": `Comparateur de courses`,
    "recap.compareBtn": `Comparer avec une autre course`, "recap.dplusTotal": `D+ total`,
    "recap.noRankYet": `Ajoute le classement et les conditions dans l'onglet Saisie pour les voir ici.`,
    "recap.zoneHr": `Temps en zone FC`, "recap.zonePower": `Temps en zone puissance`,
    "recap.pickTwoRaces": `Choisis deux courses (avec analyse remplie) à comparer.`,
    "recap.cockpitTriOnly": `La fiche visuelle n'est disponible que pour les courses de triathlon pour l'instant.`,
    "recap.transitions": `Transitions`, "common.vs": `vs`,
    ...
    "lineType.educatif": `Éducatif`,
    "nage.crawl": `Crawl`, "nage.dos": `Dos`, "nage.brasse": `Brasse`, "nage.papillon": `Papillon`,
    "nage.4n": `4 nages`, "nage.libre": `Nage libre / mixte`,
...
200m retour au calme`,
    ...
    "premium.error": `Impossible d'ouvrir le paiement`,
    "premium.unlocked": `{n} séances Sillance débloquées`,
    ...
    "sidebar.accountMovedNote": `Abonnement, assistant IA et paiements sont dans Paramètres (icône ⚙ en haut à droite).`,
    "sidebar.sillanceSub": `⭐ Abonnement Sillance`, "sidebar.subActive": `Abonnement actif`, "sidebar.manageSub": `Gérer mon abonnement`,
    "sidebar.unlockCoach": `Débloque l'espace coach en illimité.`, "sidebar.subscribe": `S'abonner`, "sidebar.perMonth": `mois`, "sidebar.seePlans": `Voir les formules`,
    ...
    "sidebar.selfCoach": `Me coacher aussi`, "sidebar.selfCoachText": `Ajoute-toi à ton propre roster : gère ton entraînement comme un athlète classique (check-in, calendrier, analyse). Compte dans ton quota d'athlètes.`,
    "sidebar.selfCoachBtn": `Activer`, "sidebar.selfCoachActive": `Auto-coaching activé · onglet Athlète débloqué`,
    ...
    "sync.stravaPrivacy": `Tes données <b>Strava</b> restent personnelles (conditions Strava). Pour les partager avec ton coach : <b>Polar/Coros</b> ou <b>import de fichier</b>.`,
    "sync.readOnly": `Strava · Polar · Coros · données en lecture seule`,
    ...
    "sync.stravaPrivacy2": `Les activités <b>Strava</b> restent personnelles à l'athlète (conditions Strava) et ne sont pas partagées au coach. Canaux partageables : <b>Polar/Coros</b> ou <b>import .FIT/.TCX/.GPX</b>.`,
    "sync.poweredBy": `Powered by Strava · Polar · Coros`, "sync.seeDetailedAnalysis": `Voir l'analyse détaillée`,
    ...
    "checkin.sendFailed": `Échec de l'envoi · vérifie ta connexion et réessaie`,
    "checkin.sentInjuryAlert": `Check-in envoyé · ton coach est alerté de ta blessure`,
    "checkin.sentPriorityAlert": `Check-in envoyé · alerte prioritaire à ton coach`,
    "checkin.sentCoachNotified": `Check-in envoyé · ton coach est prévenu`,
    "checkin.sent": `Check-in envoyé`,
    "recordSeed.halfMarathon": `Semi`,
    "chart.swimTimesTen": `Natation ×10`,

    "need.injured": `Blessé`, "need.sick": `Malade`, "need.tired": `Fatigué`,
    "need.lowForm": `Forme basse ({pct}%)`, "need.lowHrv": `HRV basse`,
    "need.zonesToRetest": `Zones à retester ({days} j)`, "need.noCheckinToday": `Pas de check-in aujourd'hui`,

    "planGap.title": `Athlètes à planifier`,
    "planGap.h72": `H-72`, "planGap.h48": `H-48`, "planGap.h24": `H-24`,
    "planGap.allSet": `Tout le monde a sa semaine · deadline {day}.`,
    "planGap.deadlineLabel": `Deadline`, "planGap.deadlineAria": `Jour deadline de la semaine`,
    "weekDeadline.friday": `Vendredi`, "weekDeadline.saturday": `Samedi`, "weekDeadline.sunday": `Dimanche`,

    "guide.whereToStart": `Par où commencer`, "guide.subtitle": `4 étapes pour lancer ton coaching.`,
    "guide.step1Title": `Crée tes séances`, "guide.step1Text": `ta bibliothèque, ou un cycle complet d'un coup.`,
    "guide.step2Title": `Ajoute un athlète`, "guide.step2Text": `invite-le par e-mail, il voit son plan.`,
    "guide.step3Title": `Connecte sa montre`, "guide.step3Text": `Garmin, Coros ou .FIT, ses séances remontent analysées.`,
    "guide.step4Title": `Planifie sa semaine`, "guide.step4Text": `glisse tes séances sur le calendrier.`,
    "guide.cta": `Créer ma première séance`,

    "invite.emailPh": `email@athlete.fr`,
    "meta.appTitle": `Sillance · Coaching triathlon`,

    "club.myClubFallback": `Mon club`,
    "auth.confirmLogOut": `Se déconnecter ?`,
    "auth.connected": `Connecté`,
    "auth.logIn": `Se connecter`,
    "auth.logOut": `Se déconnecter`,
    "auth.createAccount": `Crée ton compte`,
    "auth.logInToSpace": `Connecte-toi à ton espace`,
    "auth.fullName": `Nom complet`,
    "auth.fullNamePh": `Prénom Nom`,
    "auth.iAm": `Je suis…`,
    "auth.emailPh": `toi@mail.com`,
    "auth.password": `Mot de passe`,
    "auth.consentText": `J'accepte que Sillance traite mes données d'entraînement, y compris mes données de santé (check-ins, fréquence cardiaque), pour fournir le service. Voir la`,
    "auth.privacyPolicyLink": `politique de confidentialité`,
    "auth.createMyAccount": `Créer mon compte`,
    "auth.alreadyAccount": `Déjà un compte ?`,
    "auth.noAccountYet": `Pas encore de compte ?`,
    "auth.signUp": `S'inscrire`,
    "auth.pleaseAcceptConsent": `Merci d'accepter le traitement de tes données pour créer ton compte.`,
    "auth.accountCreatedCheckEmail": `Compte créé. Vérifie ton email puis connecte-toi.`,
    "auth.connectionError": `Erreur de connexion.`,
    "auth.errInvalidCredentials": `Email ou mot de passe incorrect.`,
    "auth.errUserExists": `Un compte existe déjà avec cet email. Essaie de te connecter.`,
    "auth.errWeakPassword": `Le mot de passe doit contenir au moins 8 caractères.`,
    "auth.errEmailNotConfirmed": `Confirme ton email avant de te connecter (vérifie ta boîte de réception).`,
    "auth.errInvalidEmail": `Adresse email invalide.`,
    "auth.errRateLimited": `Trop de tentatives. Réessaie dans quelques instants.`,
    "gate.trialOverHeading": `Ton essai gratuit est terminé`,
    "gate.trialOverText": `Abonne-toi à Sillance pour continuer à coacher tes athlètes, planifier et analyser.`,
    "gate.perMonth": `/mois`,
    "gate.subscribeToSillance": `S'abonner à Sillance`,
    "gate.lastDay": `dernier jour`,
    "gate.daysLeft": `{n} jours restants`,
    "gate.freeTrial": `Essai gratuit`,
    "gate.subscribePrice": `S'abonner (29 €/mois)`,
    "gate.trialOverText2": `Choisis la formule qui correspond au nombre d'athlètes que tu coaches · même Sillance à chaque palier.`,
    "gate.pickTier": `Choisis ta formule`,
    "gate.tier1.cap": `1 à 10 athlètes coachés`,
    "gate.tier2.cap": `11 à 30 athlètes coachés`,
    "gate.tier3.cap": `31+ athlètes coachés`,
    "gate.includedTitle": `Inclus à tous les paliers`,
    "gate.included.f1": `Planification & bibliothèque de séances`,
    "gate.included.f2": `Charge, zones perso et PMC par athlète`,
    "gate.included.f3": `Analyse Hyrox native (biomécanique, wall balls)`,
    "gate.included.f4": `Licences fédérales FFTri / FFC`,
    "gate.included.f5": `Facturation de tes athlètes intégrée`,
    "gate.selecting": `Redirection…`,
    "settings.adminTitle": `Compte modérateur`,
    "settings.adminText": `Accès complet à Sillance, sans abonnement ni paiement · usage interne.`,
    "fitImport.unreadableFit": `Fichier .FIT illisible`,
    "fitImport.cannotReadFile": `Lecture du fichier impossible.`,
    "fitImport.readError": `Erreur de lecture`,
    "fitImport.notEnoughPoints": `Pas assez de points GPS/capteur dans le fichier.`,
    "fitImport.badFitSignature": `signature .FIT absente (fichier corrompu ou mauvais format)`,
    "fitImport.bikeRide": `Sortie vélo`,
    "fitImport.activityFallback": `Activité`,
    ...
    "feel.skip": `Plus tard — je répondrai à ma prochaine connexion`,
    ...
    "coachBand.notifyReady": `Prévenir {name} que sa semaine est prête`,
    ...
    "clubSub.terms": `Abonnement mensuel, essai gratuit de 14 jours puis prélèvement chaque mois. Engagement minimum de 3 mois, résiliable ensuite à tout moment.`,
    "clubSub.choosePlan": `Choisir la formule {name}`,
    "clubSub.planChosenToast": `Formule {name} retenue · {p} €/mois{founder}. Essai gratuit de 14 jours avant le premier prélèvement.`,
    ...
    "video.placeholderHint": `Contacte le support pour en savoir plus : contact@sillance.app`,
    ...
    "today.recommendedNutrition": `Nutrition recommandée`,
    ...
    "nav.trainingPlan": `Plan d'entraînement`,
    "mode.coach": `Coach`,
    "mode.athlete": `Athlète`,
    "mode.club": `Club`,
    "a11y.colorVisionHeading": `Vision des couleurs`,
    "a11y.stdColors": `Couleurs standard`,
    "a11y.deuteranopia": `Deutéranopie`,
    "a11y.protanopia": `Protanopie`,
    "a11y.tritanopia": `Tritanopie`,
    "a11y.redGreen": `(rouge-vert)`,
    "a11y.blueYellow": `(bleu-jaune)`,
    "a11y.aidsHeading": `Aides`,
    "a11y.patternsOption": `Motifs sur les disciplines`,
    "a11y.highContrastOption": `Contraste renforcé`,
    "nav.home": `Accueil`,
    "nav.forme": `Forme & courses`,
    "nav.calendrier": `Calendrier`,
    "nav.stats": `Statistiques`,
    "nav.outils": `Outils`,
    "dash.nextRace": `Prochaine course`,
    "dash.weekLoad": `Charge semaine`,
    "dash.plannedVolume": `Volume planifié`,
    "dash.freshnessRising": `Fraîcheur en hausse`,
    "dash.completed": `Réalisé`,
    "perf.analysisBannerTitle": `Analyse de la séance & de la performance`,
    "perf.collapse": `Replier`,
    "perf.aiAssisted": `Analyse assistée`,
    "fitness.stateHeading": `État de forme`,
    "fitness.riskSuffix": `& risque`,
    "fitness.whatAnalysisLooksAt": `Ce que regarde l'analyse`,
    "perf.analysisHeading": `Analyse`,
    "perf.performanceSuffix": `performance`,
    "stats.showDetailed": `Afficher mes statistiques détaillées`,
    "stats.showDetailedHint": `Décoche si ça fait trop d'informations · tu peux revenir dessus à tout moment.`,
    "chart.cumulLoadHeading": `Charge cumulée & signaux`,
    "chart.cumulLoadSub": `· sur toute l'année du calendrier`,
    "chart.loadFitnessHeading": `Charge & forme`,
    "chart.loadFitnessSub": `· curseur synchronisé avec FTP & distance`,
    "chart.optimalFormZone": `Zone de forme optimale`,
    "chart.weeklyDistHeading": `Distance hebdomadaire`,
    "chart.lactateLabel": `Lactate`,
    "chart.durabilityHeading": `Durabilité`,
    "chart.durabilitySub": `· puissance sous fatigue`,
    "chart.raceDynamicsHeading": `Dynamiques de course`,
    "chart.raceDynamicsSub": `· zones`,
    "chart.strideOutputHeading": `Foulée & puissance`,
    "chart.cadenceGctHeading": `Tendance cadence & contact au sol`,
    "chart.trainingLoadHeading": `Charge d'entraînement`,
    "chart.trainingLoadSub": `· méthode`,
    "records.heading": `Records`,
    "records.personalSuffix": `personnels`,
    "records.runPaceTab": `Allure course`,
    "video.eyebrow": `Technique`,
    "video.libraryHeading": `Bibliothèque`,
    "video.librarySuffix": `vidéo`,
    "video.soonTitle": `Arrive bientôt`,
    "video.soonText": `La bibliothèque de vidéos techniques est en tournage.`,
    "video.soonContact": `Une question ? Écris au support : <a href="mailto:contact@sillance.app">contact@sillance.app</a>`,
    "mental.includedTag": `Inclus dans ta formule coaching`,
    "lactate.knowThresholdsTag": `Connais tes vrais seuils`,
    "lactate.bookHeading": `Réserve ton test lactate`,
    "lactate.bookMyTest": `Réserver mon test`,
    "club.eyebrow": `Espace club`,
    "club.tabDash": `Tableau de bord`,
    "club.tabSlots": `Créneaux`,
    "club.tabAttendance": `Présences`,
    "club.tabBilling": `Facturation`,
    "club.tabMembers": `Adhérents`,
    "club.tabGroups": `Groupes`,
    "club.tabOffers": `Offres`,
    "club.inviteLinkTitle": `Lien d'invitation du club`,
    "common.copy": `Copier`,
    "slot.newBadge": `Nouveau créneau`,
    "slot.groupHeading": `Créneau collectif`,
    "slot.disciplineLabel": `Discipline`,
    "slot.dayLabel": `Jour`,
    "slot.timeLabel": `Heure`,
    "slot.titleLabel": `Intitulé`,
    "slot.durationLabel": `Durée (min)`,
    "slot.placeLabel": `Lieu`,
    "slot.capacityLabel": `Places max`,
    "slot.contentLabel": `Contenu de la séance`,
    "slot.groupRestrictedLabel": `Groupe (contenu réservé)`,
    "slot.wholeClubOption": `Tout le club`,
    "slot.badge": `Créneau`,
    "slot.descTab": `Description`,
    "slot.participantsTab": `Participants`,
    "group.newBadge": `Nouveau groupe`,
    "group.nameLabel": `Nom du groupe`,
    "group.descLabel": `Description (optionnel)`,
    "group.colorLabel": `Couleur`,
    "group.membersLabel": `Athlètes du groupe`,
    "parental.athleteIsPrefix": `Cet athlète est`,
    "parental.minorWord": `mineur`,
    "parental.under18": `(moins de 18 ans)`,
    "parental.guardianNameLabel": `Nom du représentant légal`,
    "license.federationLabel": `Fédération`,
    "license.validUntilLabel": `Certificat médical valable jusqu'au`,
    "athlete.backgroundLabel": `Parcours sportif`,
    "records.personalLabel": `Records personnels`,
    "athlete.injuryHistoryLabel": `Historique de blessures`,
    "athlete.dietLabel": `Habitudes alimentaires`,
    "race.debriefsLabel": `Débriefs de course (remplis par l'athlète)`,
    "race.debriefsHeading": `Débriefs de course`,
    "coach.teamLabel": `Équipe de coachs`,
    "coach.proposeAdditional": `Proposer un coach supplémentaire`,
    "coach.emailLabel": `Email du coach`,
    "coach.roleOptionalLabel": `Rôle (optionnel)`,
    "share.spectatorNoteLabel": `Repères pour tes proches (optionnel)`,
    "race.debriefHeading": `Comment s'est passée ta course ?`,
    "race.nameLabel": `Course`,
    "common.date": `Date`,
    "race.resultLabel": `Ressenti général`,
    "race.nutritionFollowedLabel": `Nutrition suivie comme prévu ?`,
    "common.yes": `Oui`,
    "common.partially": `Partiellement`,
    "common.no": `Non`,
    "race.weatherLabel": `Météo`,
    "race.whatWentWellLabel": `Ce qui a bien marché`,
    "race.whatDidntLabel": `Ce qui a coincé`,
    "request.acceptAthleteHeading": `Accepter l'athlète`,
    "request.assignGroupLabel": `Affecter au groupe`,
    "gear.newHeading": `Nouvel équipement`,
    "gear.typeLabel": `Type`,
    "gear.runningShoesOption": `Chaussures de course`,
    "gear.searchModelLabel": `Cherche ton modèle`,
    "gear.kmDoneLabel": `Km déjà parcourus`,
    "gear.lifespanLabel": `Durée de vie (km)`,
    "mental.chooseCoachThenSlot": `Choisis ton préparateur, puis ton créneau.`,
    "common.fullName": `Nom complet`,
    "common.email": `Email`,
    "lactate.testTypeLabel": `Type de test`,
    "common.both": `Les deux`,
    "lactate.periodLabel": `Période souhaitée`,
    "common.sendRequest": `Envoyer ma demande`,
    "chart.speedHeading": `Vitesse`,
    "chart.hrHeading": `Fréquence cardiaque`,
    "perf.conditionsImpactHeading": `Impact des conditions`,
    "perf.conditionsImpactHint": `ce que l'environnement t'a coûté`,
    "perf.biomechanicsHeading": `Biomécanique`,
    "perf.biomechanicsHint": `dynamiques de course, si la montre les fournit`,
    "chart.cadenceHeading": `Cadence`,
    "chart.strideLenHeading": `Longueur de foulée`,
    "chart.decouplingHeading": `Découplage`,
    "chart.decouplingHint": `efficacité cardiaque sur la durée`,
    "perf.lapDetailHeading": `Détail par lap`,
    "perf.similarSessionsHeading": `Séances similaires`,
    "perf.autoComparison": `comparaison automatique`,
    "cycle.newBadge": `Nouveau cycle`,
    "cycle.startWeekLabel": `Semaine de départ :`,
    "session.newBadge": `Nouvelle séance`,
    "session.goalAutoOption": `Objectif : auto`,
    "session.refsShownLabel": `Références affichées :`,
    "session.beforeSessionLabel": `Avant la séance`,
    "session.duringSessionLabel": `Pendant l'effort`,
    "session.afterSessionLabel": `Après la séance (récup)`,
    "common.clickToEnlarge": `Clic pour ouvrir en grand`,

    "a11y.optionsAria": `Options d'accessibilité`,
    "athlete.allergiesPh": `Allergies, régime, préférences…`,
    "athlete.experiencePh": `Depuis quand il/elle pratique, expérience, contexte…`,
    "athlete.namePh": `Ex. Claire Rousseau`,
    "athlete.schedulePh": `Horaires, métier physique ou sédentaire, contraintes…`,
    "athlete.searchAria": `Rechercher un athlète`,
    "athlete.searchPh": `Rechercher un athlète…`,
    "athlete.sheetAria": `Fiche athlète`,
    "athlete.trackedAria": `Athlète suivi`,
    "athlete.weightPh": `Ex. 58`,
    "calendar.trainingAria": `Calendrier d'entraînement`,
    "chart.altitudeAria": `Profil d'altitude`,
    "chart.cadenceAria": `Cadence`,
    "chart.cadenceGctAria": `Tendance cadence et temps de contact au sol`,
    "chart.decouplingAria": `Courbe de découplage`,
    "chart.durabilityAria": `Courbe de durabilité`,
    "chart.ftpPmaAria": `Évolution FTP et PMA`,
    "chart.hrCurveAria": `Courbe de fréquence cardiaque`,
    "chart.hrZonesAria": `Répartition des zones cardiaques`,
    "chart.lactateAria": `Courbe lactate vélo`,
    "chart.loadAria": `Charge cumulée par discipline, fatigue, risque de blessure et forme`,
    "chart.loadFitnessAria": `Évolution de la charge et de la forme`,
    "chart.powerAria": `Courbe de puissance`,
    "chart.clickToZoom": `cliquer pour zoomer`,
    "chart.zoomAria": `Détail du graphique`,
    "chart.zoomChartAria": `Graphique détaillé, zoomable`,
    "chart.zoomHint": `Molette : zoomer · glisser : déplacer`,
    "chart.zoomReset": `Réinitialiser`,
    "chart.powerDurationAria": `Courbe puissance-durée`,
    "chart.speedAria": `Courbe de vitesse`,
    "chart.strideAria": `Longueur de foulée`,
    "chart.weeklyDistAria": `Distance hebdomadaire par discipline`,
    "charts.chooseAria": `Choisir les graphiques à afficher`,
    "coach.addAria": `Ajouter un coach`,
    "coach.emailPh": `prenom@exemple.com`,
    "coach.rolePh": `Ex. Vélo, Course, Nutrition, Data…`,
    "cycle.createAria": `Création de cycle`,
    "cycle.durationAria": `Durée du cycle`,
    "cycle.nameAria": `Nom du cycle`,
    "cycle.namePh": `Nom du cycle (ex. Endurance hiver, Affûtage course A…)`,
    "cycle.optionalPh": `Optionnel`,
    "cycle.weekPh": `ex. semaine du 23 juin`,
    "display.optionsAria": `Options d'affichage et de couleurs`,
    "display.optionsTitle": `Affichage & couleurs`,
    "fitness.analysisAria": `Analyse de l'état de forme`,
    "gear.addAria": `Ajouter un équipement`,
    "gear.freeTextPh": `Ou saisis-le librement s'il n'est pas dans le catalogue`,
    "gear.modelPh": `Ex. Pegasus, Novablast, Vaporfly…`,
    "group.createAria": `Créer un groupe`,
    "group.descPh": `Ex. Longue distance, format Ironman`,
    "group.namePh": `Ex. Adultes Triathlon Ironman`,
    "invite.linkAria": `Lien d'invitation à partager`,
    "lactate.bookAria": `Réserver un test lactate`,
    "license.medicalAria": `Licence et certificat médical`,
    "license.numberPh": `Ex. 1234567`,
    "mental.availableAria": `Préparateurs mentaux disponibles`,
    "mental.bookingAria": `Prise de rendez-vous prépa mentale`,
    "mental.calendlyTitle": `Agenda de réservation · préparation mentale`,
    "mental.prepAria": `Préparation mentale`,
    "message.aria": `Message`,
    "message.ph": `Écris un message…`,
    "message.sendAria": `Envoyer`,
    "messaging.aria": `Messagerie`,
    "modal.closeAria": `Fermer`,
    "nav.athleteNav": `Navigation athlète`,
    "nav.displayMode": `Mode d'affichage`,
    "nav.help": `Aide`,
    "nav.helpTitle": `Aide & guide`,
    "nav.nextWeek": `Semaine suivante`,
    "nav.prevWeek": `Semaine précédente`,
    "nav.weeksNav": `Navigation des semaines`,
    "calendar.viewWeek": `Semaine`, "calendar.viewDay": `Jour`, "calendar.viewAria": `Vue du calendrier`,
    "notif.aria": `Notifications`, "notif.ariaWithCount": `Notifications ({n})`,
    "notif.athleteAlerts": `Alertes athlètes`,
    "notif.title": `Alertes`,
    "parental.consentAria": `Consentement parental`,
    "parental.emailPh": `parent@exemple.fr`,
    "race.debriefAria": `Débrief de course`,
    "race.feltPh": `Comment tu t'es senti pendant la course…`,
    "race.instructionsPh": `Ex. À 30 km, ralentis si FC > 170. Ravito prévu au km 15.`,
    "race.namePh": `Ex. Gorillaman Sprint`,
    "race.resultPh": `Ex. 1h12, ou position au général`,
    "race.weatherPh": `Ex. chaud, pluie, vent…`,
    "request.acceptAria": `Accepter une demande`,
    "session.analysisAria": `Analyse de la séance`,
    "session.createAria": `Création de séance`,
    "session.goalAria": `Objectif de la séance`,
    "session.goalTitle": `Objectif de la séance · sert à l'analyse IA`,
    "session.notePh": `Auto selon le type · ou écris ta consigne`,
    "session.duringPh": `Ex. 60–80 g de glucides/h`,
    "session.nutritionPh": `Ex. protéines dans les 30 min + glucides`,
    "session.sportAria": `Sport`,
    "session.titleAria": `Titre de la séance`,
    "session.titlePh": `Titre de la séance (ex. Seuil 4×8' FTP)`,
    "settings.label": `Paramètres`,
    "share.relativesAria": `Partager avec les proches`,
    "sidebar.panelAria": `Panneau latéral`,
    "slot.coachNamePh": `Nom du coach`,
    "slot.createAria": `Créer un créneau`,
    "slot.descPh": `Ex. 6×400m allure 5 km récup 1' + gainage · visible par les inscrits`,
    "slot.placePh": `Ex. Stade / Salle Hyrox`,
    "slot.sheetAria": `Fiche du créneau`,
    "slot.titlePh": `Ex. Séance piste collective`,
    "theme.changeAria": `Changer de thème`,
    "theme.changeTitle": `Mode clair / sombre`,
    "today.pointAria": `Ton point du jour`,
    "tour.guidedAria": `Tutoriel guidé`,
    "tour.guidedTitle": `Tutoriel guidé · créer une séance`,
    "video.filterSportAria": `Filtrer par sport`,
    "video.gridTitle": `Afficher la grille modulaire (Müller-Brockmann)`,
    "video.libraryAria": `Bibliothèque vidéo`,
    "video.playerAria": `Lecteur vidéo`,
    "video.searchAria": `Rechercher une vidéo`,
    "video.searchPh": `Rechercher (rattrapé, gammes, squat…)`,
    "week.summaryAria": `Résumé de la semaine`,
    "whatsapp.openTitle": `Ouvrir dans WhatsApp`,
    ...
    "tour.welcome.title": `Bienvenue sur Sillance !`,
    "tour.welcome.text": `On va créer ta première séance ensemble · une séance de course à pied, avec échauffement, un intervalle d'effort et une récupération.`,
    "tour.welcome.cta": `C'est parti`,
    "tour.create.title": `Créer une séance`,
    "tour.create.text": `Clique sur ce bouton pour ouvrir le créateur de séance.`,
    "tour.sport.title": `Choisis le sport`,
    "tour.sport.text": `Sélectionne « Course à pied » pour cette démo.`,
    "tour.warmup.title": `Échauffement déjà prêt`,
    "tour.warmup.text": `Un échauffement est ajouté automatiquement à chaque séance. Tu peux ajuster sa durée ou son intensité ici.`,
    "tour.warmup.cta": `Suivant`,
    "tour.addexo.title": `Ajoute un exercice`,
    "tour.addexo.text": `Clique pour ajouter un intervalle d'effort à ce bloc.`,
    "tour.intensity.title": `Règle l'intensité`,
    "tour.intensity.text": `Choisis une zone d'intensité pour cet effort · par exemple Seuil ou VMA.`,
    "tour.recov.title": `Ajoute une récupération`,
    "tour.recov.text": `Clique pour ajouter une récupération après l'effort.`,
    "tour.series.title": `Crée des intervalles`,
    "tour.series.text": `Augmente le nombre de séries pour répéter ce bloc plusieurs fois : c'est ça, un intervalle. Essaie ×5.`,
    "tour.save.title": `Enregistre la séance`,
  ...
  var en = {
    "payReturn.titleSuccess": `Payment confirmed`,
    "payReturn.titleCancel": `Payment cancelled`,
    "payReturn.continue": `Continue`,
    "payReturn.checkout.success": `Your Coach subscription is active. Welcome.`,
    "payReturn.checkout.cancel": `The payment was cancelled, your subscription hasn't changed.`,
    "payReturn.ai.success": `The AI Assistant is now active on your account.`,
    "payReturn.ai.cancel": `Activating the AI Assistant was cancelled.`,
    "payReturn.coaching.success": `Your coaching subscription is active.`,
    "payReturn.coaching.cancel": `The coaching subscription wasn't activated.`,
    "payReturn.clubSub.success": `Your club's Sillance subscription is active.`,
    "payReturn.clubSub.cancel": `The club subscription wasn't activated.`,
    "payReturn.videos.success": `Video access was updated for your athletes.`,
    "payReturn.videos.cancel": `Updating video access was cancelled.`,
    "payReturn.creneau.success": `Your spot is booked, the payment is confirmed.`,
    "payReturn.creneau.cancel": `The booking wasn't confirmed, the payment was cancelled.`,
    "payReturn.coachConnect.success": `Your Stripe account is linked. You can now get paid by your athletes.`,
    "payReturn.coachConnect.cancel": `Linking your Stripe account isn't finished. Try again anytime from the "Get paid" banner.`,
    "payReturn.clubConnect.success": `The club's Stripe account is linked. Member payments can now be collected.`,
    "payReturn.clubConnect.cancel": `Linking the club's Stripe account isn't finished. Try again from the billing settings.`,
    "payReturn.premium.success": `Sillance Premium Club is active: the AI Assistant and the library are unlocked for the club's staff.`,
    "payReturn.premium.cancel": `The Sillance Premium Club subscription wasn't activated.`,
    ...
    "toast.selfCoachEnabled": `Self-coaching enabled · switch to the Athlete tab to manage your training.`,
    "toast.selfCoachError": `Couldn't enable self-coaching, try again.`,
    "toast.assistantIaActiveEssai14": `AI Assistant activated · 14-day trial (demo)`,
    "toast.athleteNotifiedReady": `{name} was notified their week is ready`,
    ...
    "deviceReturn.connectedZero": `{provider} connected.`,
    "deviceReturn.connectedSingular": `{provider} connected, {n} activity imported.`,
    "deviceReturn.connectedPlural": `{provider} connected, {n} activities imported.`,
    "deviceReturn.error": `The connection failed. Try again from the Sync card.`,
    ...
    "ready.recoveryReady": `Ready for a hard effort now`,
    "ready.recoveryIn": `Hard effort possible in {time}`,
    "ready.recoveryHours": `{h}h`, "ready.recoveryDays": `{d}d`, "ready.recoveryDaysHours": `{d}d {h}h`,
    "predict.heading": `Race predictor`, "predict.sub": `estimated from threshold pace and current fitness`,
    "predict.half": `Half`, "predict.marathon": `Marathon`,
    "mono.heading": `Monotony & Strain`, "mono.sub": `7-day load variability (Foster method)`,
    "mono.high": `High`, "mono.ok": `Fine`,
    "mono.strainNote": `Weekly strain ≈ {strain} · high monotony (≥2) flags a flat load with no real recovery, even when ACWR looks fine.`,
    "block.heading": `Block-to-block history`, "block.sub": `average weekly load, compared periods`,
    "block.prev12": `Previous 12 wks`, "block.last4": `Last 4 wks`, "block.avgLoadWeek": `load/wk`,
    "dash.widgetsHeading": `Visible widgets`, "dash.widgetsSub": `Choose what shows on your coach sidebar and fitness dashboard.`,
    "dash.widgetNeedRadar": `Who needs you this week`, "dash.widgetPlanningRadar": `Planning reminder`,
    "dash.widgetReadyhub": `Fitness & risk state`, "dash.widgetAdvanced": `Advanced load (predictor, monotony, blocks)`,
    "dash.widgetNutritionToday": `Recommended nutrition (Today's point) — uses your "during effort" note`,
    "dash.alertsHeading": `Custom alerts`, "dash.alertsSub": `Set your own thresholds: once crossed, the athlete rises in the "who needs you" radar.`,
    "dash.noAlerts": `No custom alert yet.`, "dash.threshold": `Threshold`,
    "dash.addAlert": `+ Add`, "dash.thresholdRequired": `Enter a threshold.`, "dash.alertAdded": `Alert added.`,
    "clubFilter.allSports": `All sports`, "clubFilter.allGroups": `All groups`, "clubFilter.allLevels": `All levels`,
    "level.debutant": `Beginner`, "level.confirme": `Intermediate`, "level.competition": `Competitive`,
    "season.title": `Season calendar`, "season.btn": `Season`, "season.add": `+ Add`,
    "season.empty": `No race logged yet.`, "season.addResult": `+ add result`,
    "season.resultFor": `Result — {name}`, "season.fillNameDate": `Enter at least a name and a date.`, "season.added": `Race added to the calendar.`,
    "season.saveError": `Couldn't save the race, try again.`, "season.myRaces": `My races`, "season.openMine": `View my season calendar`,
    "compareAth.btn": `Compare 2 athletes`, "compareAth.title": `Compare two athletes`,
    "compareAth.forme": `Form (check-in)`, "compareAth.hrv": `HRV`, "compareAth.drop": `Decoupling`, "compareAth.racedays": `Days to race`,
    "compareAth.pickTwo": `Pick two different athletes to compare.`, "compareAth.noData": `No comparable data yet for these two athletes.`,
    "recap.title": `Race analysis`, "recap.typeRun": `Running race`, "recap.typeTri": `Triathlon`, "recap.typeHyrox": `Hyrox`,
    "recap.editLink": `Edit analysis`, "recap.addLink": `+ Race analysis`,
    "recap.totalTime": `Total time`, "recap.avgPace": `Avg pace`, "recap.avgHr": `Avg HR`,
    ...
    "recap.runN": `Run {n}`, "recap.runLeg": `1 km`, "recap.roxzone": `Roxzone`,
    "recap.raceInfo": `Rank & conditions`, "recap.rankScratch": `Scratch`, "recap.rankTotal": `Out of`,
    "recap.rankCat": `Cat. rank`, "recap.catLabel": `Category`, "recap.temp": `Temperature (°C)`,
    "recap.wind": `Wind (km/h)`, "recap.dplusBike": `Bike elevation (m)`, "recap.dplusRun": `Run elevation (m)`,
    "recap.preRaceNutrition": `Pre-race`, "recap.carbs": `Carbs (g)`, "recap.liquid": `Liquid (L)`,
    "recap.note": `Note`, "recap.notePh": `Feeling, digestive tolerance…`, "recap.pace100": `Pace /100m`,
    "recap.nutritionNote": `Nutrition`, "recap.hrMax": `Max HR`,
    "recap.editView": `Edit`, "recap.cockpitView": `Card`, "recap.compareTitle": `Race comparator`,
    "recap.compareBtn": `Compare with another race`, "recap.dplusTotal": `Total elevation`,
    "recap.noRankYet": `Add rank and conditions in the Edit tab to see them here.`,
    "recap.zoneHr": `Time in HR zone`, "recap.zonePower": `Time in power zone`,
    "recap.pickTwoRaces": `Pick two races (with a filled-in analysis) to compare.`,
    "recap.cockpitTriOnly": `The visual card is only available for triathlon races for now.`,
    "recap.transitions": `Transitions`, "common.vs": `vs`,
    ...
    "lineType.educatif": `Drill`,
    "nage.crawl": `Front crawl`, "nage.dos": `Backstroke`, "nage.brasse": `Breaststroke`, "nage.papillon": `Butterfly`,
    "nage.4n": `Individual medley`, "nage.libre": `Free / mixed stroke`,
...
200m retour au calme`,
    ...
    "premium.error": `Couldn't open checkout`,
    "premium.unlocked": `{n} Sillance sessions unlocked`,
    ...
    "sidebar.accountMovedNote": `Subscription, AI assistant and payments now live in Settings (⚙ icon, top right).`,
    "sidebar.sillanceSub": `⭐ Sillance subscription`, "sidebar.subActive": `Active subscription`, "sidebar.manageSub": `Manage my subscription`,
    "sidebar.unlockCoach": `Unlock unlimited coach space.`, "sidebar.subscribe": `Subscribe`, "sidebar.perMonth": `month`, "sidebar.seePlans": `See plans`,
    ...
    "sidebar.selfCoach": `Coach myself too`, "sidebar.selfCoachText": `Add yourself to your own roster: manage your training like a regular athlete (check-in, calendar, analysis). Counts toward your athlete quota.`,
    "sidebar.selfCoachBtn": `Enable`, "sidebar.selfCoachActive": `Self-coaching enabled · Athlete tab unlocked`,
    ...
    "sync.stravaPrivacy": `Your <b>Strava</b> data stays personal (Strava's terms). To share it with your coach: <b>Polar/Coros</b> or <b>file import</b>.`,
    "sync.readOnly": `Strava · Polar · Coros · read-only data`,
    ...
    "sync.stravaPrivacy2": `<b>Strava</b> activities stay personal to the athlete (Strava's terms) and aren't shared with the coach. Shareable channels: <b>Polar/Coros</b> or <b>.FIT/.TCX/.GPX import</b>.`,
    "sync.poweredBy": `Powered by Strava · Polar · Coros`, "sync.seeDetailedAnalysis": `See detailed analysis`,
    ...
    "checkin.sendFailed": `Couldn't send · check your connection and try again`,
    "checkin.sentInjuryAlert": `Check-in sent · your coach is alerted about your injury`,
    "checkin.sentPriorityAlert": `Check-in sent · priority alert sent to your coach`,
    "checkin.sentCoachNotified": `Check-in sent · your coach has been notified`,
    "checkin.sent": `Check-in sent`,
    "recordSeed.halfMarathon": `Half marathon`,
    "chart.swimTimesTen": `Swimming ×10`,

    "need.injured": `Injured`, "need.sick": `Sick`, "need.tired": `Tired`,
    "need.lowForm": `Low form ({pct}%)`, "need.lowHrv": `Low HRV`,
    "need.zonesToRetest": `Zones to retest ({days} d)`, "need.noCheckinToday": `No check-in today`,

    "planGap.title": `Athletes to plan`,
    "planGap.h72": `H-72`, "planGap.h48": `H-48`, "planGap.h24": `H-24`,
    "planGap.allSet": `Everyone has their week · deadline {day}.`,
    "planGap.deadlineLabel": `Deadline`, "planGap.deadlineAria": `Week deadline day`,
    "weekDeadline.friday": `Friday`, "weekDeadline.saturday": `Saturday`, "weekDeadline.sunday": `Sunday`,

    "guide.whereToStart": `Where to start`, "guide.subtitle": `4 steps to launch your coaching.`,
    "guide.step1Title": `Create your sessions`, "guide.step1Text": `your library, or a full cycle at once.`,
    "guide.step2Title": `Add an athlete`, "guide.step2Text": `invite them by email, they see their plan.`,
    "guide.step3Title": `Connect their watch`, "guide.step3Text": `Garmin, Coros or .FIT · their sessions sync in, analyzed.`,
    "guide.step4Title": `Plan their week`, "guide.step4Text": `drag your sessions onto the calendar.`,
    "guide.cta": `Create my first session`,

    "invite.emailPh": `email@athlete.com`,
    "meta.appTitle": `Sillance · Triathlon coaching`,

    "club.myClubFallback": `My club`,
    "auth.confirmLogOut": `Log out?`,
    "auth.connected": `Connected`,
    "auth.logIn": `Log in`,
    "auth.logOut": `Log out`,
    "auth.createAccount": `Create your account`,
    "auth.logInToSpace": `Log in to your space`,
    "auth.fullName": `Full name`,
    "auth.fullNamePh": `First Last`,
    "auth.iAm": `I am…`,
    "auth.emailPh": `you@mail.com`,
    "auth.password": `Password`,
    "auth.consentText": `I agree that Sillance processes my training data, including health data (check-ins, heart rate), to provide the service. See the`,
    "auth.privacyPolicyLink": `privacy policy`,
    "auth.createMyAccount": `Create my account`,
    "auth.alreadyAccount": `Already have an account?`,
    "auth.noAccountYet": `No account yet?`,
    "auth.signUp": `Sign up`,
    "auth.pleaseAcceptConsent": `Please accept data processing to create your account.`,
    "auth.accountCreatedCheckEmail": `Account created. Check your email, then log in.`,
    "auth.connectionError": `Connection error.`,
    "auth.errInvalidCredentials": `Incorrect email or password.`,
    "auth.errUserExists": `An account already exists with this email. Try logging in instead.`,
    ...
    "auth.errRateLimited": `Too many attempts. Try again in a moment.`,
    "gate.trialOverHeading": `Your free trial has ended`,
    "gate.trialOverText": `Subscribe to Sillance to keep coaching your athletes, planning and analyzing.`,
    "gate.perMonth": `/month`,
    "gate.subscribeToSillance": `Subscribe to Sillance`,
    "gate.lastDay": `last day`,
    "gate.daysLeft": `{n} days left`,
    "gate.freeTrial": `Free trial`,
    "gate.subscribePrice": `Subscribe (€29/month)`,
    "gate.trialOverText2": `Pick the plan that matches how many athletes you coach · the same Sillance at every tier.`,
    "gate.pickTier": `Choose your plan`,
    "gate.tier1.cap": `1 to 10 athletes coached`,
    "gate.tier2.cap": `11 to 30 athletes coached`,
    "gate.tier3.cap": `31+ athletes coached`,
    "gate.includedTitle": `Included at every tier`,
    "gate.included.f1": `Planning & session library`,
    "gate.included.f2": `Training load, custom zones and PMC per athlete`,
    "gate.included.f3": `Native Hyrox analysis (biomechanics, wall balls)`,
    "gate.included.f4": `Federation licenses (FFTri / FFC)`,
    "gate.included.f5": `Built-in athlete billing`,
    "gate.selecting": `Redirecting…`,
    "settings.adminTitle": `Moderator account`,
    "settings.adminText": `Full access to Sillance, no subscription or payment · internal use.`,
    "fitImport.unreadableFit": `Unreadable .FIT file`,
    "fitImport.cannotReadFile": `Could not read the file.`,
    "fitImport.readError": `Read error`,
    "fitImport.notEnoughPoints": `Not enough GPS/sensor points in the file.`,
    "fitImport.badFitSignature": `missing .FIT signature (corrupt file or wrong format)`,
    "fitImport.bikeRide": `Bike ride`,
    "fitImport.activityFallback": `Activity`,
    ...
    "feel.validate": `Save`,
    "feel.skip": `Later — I'll answer next time I log in`,
    ...
    "coachBand.notifyReady": `Notify {name} their week is ready`,
    ...
    "clubSub.terms": `Monthly subscription, 14-day free trial then a charge each month. 3-month minimum commitment, cancellable anytime after that.`,
    "clubSub.choosePlan": `Choose the {name} plan`,
    "clubSub.planChosenToast": `{name} plan selected · €{p}/month{founder}. 14-day free trial before the first charge.`,
    ...
    "video.placeholderHint": `Questions? Contact support: contact@sillance.app`,
    ...
    "today.recommendedNutrition": `Recommended nutrition`,
    ...
    "mode.club": `Club`,
    "a11y.colorVisionHeading": `Color vision`,
    "a11y.stdColors": `Standard colors`,
    "a11y.deuteranopia": `Deuteranopia`,
    "a11y.protanopia": `Protanopia`,
    "a11y.tritanopia": `Tritanopia`,
    "a11y.redGreen": `(red-green)`,
    "a11y.blueYellow": `(blue-yellow)`,
    "a11y.aidsHeading": `Aids`,
    "a11y.patternsOption": `Patterns on disciplines`,
    "a11y.highContrastOption": `High contrast`,
    "nav.home": `Home`,
    "nav.forme": `Form & races`,
    "nav.calendrier": `Calendar`,
    "nav.stats": `Stats`,
    "nav.outils": `Tools`,
    "dash.nextRace": `Next race`,
    "dash.weekLoad": `Week load`,
    "dash.plannedVolume": `Planned volume`,
    "dash.freshnessRising": `Freshness rising`,
    "dash.completed": `Completed`,
    "perf.analysisBannerTitle": `Session & performance analysis`,
    "perf.collapse": `Collapse`,
    "perf.aiAssisted": `AI-assisted analysis`,
    "fitness.stateHeading": `Fitness`,
    "fitness.riskSuffix": `& risk`,
    "fitness.whatAnalysisLooksAt": `What the analysis looks at`,
    "perf.analysisHeading": `Analysis`,
    "perf.performanceSuffix": `performance`,
    "stats.showDetailed": `Show my detailed stats`,
    "stats.showDetailedHint": `Uncheck if it's too much information · you can turn it back on anytime.`,
    "chart.cumulLoadHeading": `Cumulative load & signals`,
    "chart.cumulLoadSub": `· across the whole calendar year`,
    "chart.loadFitnessHeading": `Load & fitness`,
    "chart.loadFitnessSub": `· slider synced with FTP & distance`,
    "chart.optimalFormZone": `Optimal fitness zone`,
    "chart.weeklyDistHeading": `Weekly distance`,
    "chart.lactateLabel": `Lactate`,
    "chart.durabilityHeading": `Durability`,
    "chart.durabilitySub": `· power under fatigue`,
    "chart.raceDynamicsHeading": `Race dynamics`,
    "chart.raceDynamicsSub": `· zones`,
    "chart.strideOutputHeading": `Stride & output`,
    "chart.cadenceGctHeading": `Cadence & ground contact trend`,
    "chart.trainingLoadHeading": `Training load`,
    "chart.trainingLoadSub": `· method`,
    "records.heading": `Records`,
    "records.personalSuffix": `personal bests`,
    "records.runPaceTab": `Run pace`,
    "video.eyebrow": `Technique`,
    "video.libraryHeading": `Video`,
    "video.librarySuffix": `library`,
    "video.soonTitle": `Coming soon`,
    "video.soonText": `The technique video library is being filmed.`,
    "video.soonContact": `Questions? Write to support: <a href="mailto:contact@sillance.app">contact@sillance.app</a>`,
    "mental.includedTag": `Included in your coaching plan`,
    "lactate.knowThresholdsTag": `Know your real thresholds`,
    "lactate.bookHeading": `Book your lactate test`,
    "lactate.bookMyTest": `Book my test`,
    "club.eyebrow": `Club space`,
    "club.tabDash": `Dashboard`,
    "club.tabSlots": `Time slots`,
    "club.tabAttendance": `Attendance`,
    "club.tabBilling": `Billing`,
    "club.tabMembers": `Members`,
    "club.tabGroups": `Groups`,
    "club.tabOffers": `Offers`,
    "club.inviteLinkTitle": `Club invite link`,
    "common.copy": `Copy`,
    "slot.newBadge": `New time slot`,
    "slot.groupHeading": `Group slot`,
    "slot.disciplineLabel": `Discipline`,
    "slot.dayLabel": `Day`,
    "slot.timeLabel": `Time`,
    "slot.titleLabel": `Title`,
    "slot.durationLabel": `Duration (min)`,
    "slot.placeLabel": `Location`,
    "slot.capacityLabel": `Max spots`,
    "slot.contentLabel": `Session content`,
    "slot.groupRestrictedLabel": `Group (restricted content)`,
    "slot.wholeClubOption": `Whole club`,
    "slot.badge": `Time slot`,
    "slot.descTab": `Description`,
    "slot.participantsTab": `Participants`,
    "group.newBadge": `New group`,
    "group.nameLabel": `Group name`,
    "group.descLabel": `Description (optional)`,
    "group.colorLabel": `Color`,
    "group.membersLabel": `Group athletes`,
    "parental.athleteIsPrefix": `This athlete is`,
    "parental.minorWord": `a minor`,
    "parental.under18": `(under 18)`,
    "parental.guardianNameLabel": `Legal guardian's name`,
    "license.federationLabel": `Federation`,
    "license.validUntilLabel": `Medical certificate valid until`,
    "athlete.backgroundLabel": `Sporting background`,
    "records.personalLabel": `Personal records`,
    "athlete.injuryHistoryLabel": `Injury history`,
    "athlete.dietLabel": `Dietary habits`,
    "race.debriefsLabel": `Race debriefs (filled in by the athlete)`,
    "race.debriefsHeading": `Race debriefs`,
    "coach.teamLabel": `Coaching team`,
    "coach.proposeAdditional": `Propose an additional coach`,
    "coach.emailLabel": `Coach's email`,
    "coach.roleOptionalLabel": `Role (optional)`,
    "share.spectatorNoteLabel": `Notes for your family & friends (optional)`,
    "race.debriefHeading": `How did your race go?`,
    "race.nameLabel": `Race`,
    "common.date": `Date`,
    "race.resultLabel": `Overall feeling`,
    "race.nutritionFollowedLabel": `Nutrition plan followed?`,
    "common.yes": `Yes`,
    "common.partially": `Partially`,
    "common.no": `No`,
    "race.weatherLabel": `Weather`,
    "race.whatWentWellLabel": `What went well`,
    "race.whatDidntLabel": `What didn't go well`,
    "request.acceptAthleteHeading": `Accept the athlete`,
    "request.assignGroupLabel": `Assign to a group`,
    "gear.newHeading": `New gear`,
    "gear.typeLabel": `Type`,
    "gear.runningShoesOption": `Running shoes`,
    "gear.searchModelLabel": `Search for your model`,
    "gear.kmDoneLabel": `Km already covered`,
    "gear.lifespanLabel": `Lifespan (km)`,
    "mental.chooseCoachThenSlot": `Choose your coach, then your time slot.`,
    "common.fullName": `Full name`,
    "common.email": `Email`,
    "lactate.testTypeLabel": `Test type`,
    "common.both": `Both`,
    "lactate.periodLabel": `Preferred period`,
    "common.sendRequest": `Send my request`,
    "chart.speedHeading": `Speed`,
    "chart.hrHeading": `Heart rate`,
    "perf.conditionsImpactHeading": `Impact of conditions`,
    "perf.conditionsImpactHint": `what the environment cost you`,
    "perf.biomechanicsHeading": `Biomechanics`,
    "perf.biomechanicsHint": `running dynamics, if your watch provides them`,
    "chart.cadenceHeading": `Cadence`,
    "chart.strideLenHeading": `Stride length`,
    "chart.decouplingHeading": `Decoupling`,
    "chart.decouplingHint": `cardiac efficiency over time`,
    "perf.lapDetailHeading": `Lap detail`,
    "perf.similarSessionsHeading": `Similar sessions`,
    "perf.autoComparison": `automatic comparison`,
    "cycle.newBadge": `New cycle`,
    "cycle.startWeekLabel": `Start week:`,
    "session.newBadge": `New session`,
    "session.goalAutoOption": `Goal: auto`,
    "session.refsShownLabel": `References shown:`,
    "session.beforeSessionLabel": `Before the session`,
    "session.duringSessionLabel": `During the effort`,
    "session.afterSessionLabel": `After the session (recovery)`,
    "common.clickToEnlarge": `Click to enlarge`,

    "a11y.optionsAria": `Accessibility options`,
    "athlete.allergiesPh": `Allergies, diet, preferences…`,
    "athlete.experiencePh": `How long they've trained, experience, context…`,
    "athlete.namePh": `E.g. Claire Rousseau`,
    "athlete.schedulePh": `Schedule, physical or sedentary job, constraints…`,
    "athlete.searchAria": `Search for an athlete`,
    "athlete.searchPh": `Search for an athlete…`,
    "athlete.sheetAria": `Athlete profile`,
    "athlete.trackedAria": `Tracked athlete`,
    "athlete.weightPh": `E.g. 58`,
    "calendar.trainingAria": `Training calendar`,
    "chart.altitudeAria": `Elevation profile`,
    "chart.cadenceAria": `Cadence`,
    "chart.cadenceGctAria": `Cadence and ground contact time trend`,
    "chart.decouplingAria": `Decoupling curve`,
    "chart.durabilityAria": `Durability curve`,
    "chart.ftpPmaAria": `FTP and MAP trend`,
    "chart.hrCurveAria": `Heart rate curve`,
    "chart.hrZonesAria": `Heart rate zone breakdown`,
    "chart.lactateAria": `Bike lactate curve`,
    "chart.loadAria": `Cumulative load by discipline, fatigue, injury risk and fitness`,
    "chart.loadFitnessAria": `Load and fitness trend`,
    "chart.powerAria": `Power curve`,
    "chart.clickToZoom": `click to zoom`,
    "chart.zoomAria": `Chart detail`,
    "chart.zoomChartAria": `Detailed, zoomable chart`,
    "chart.zoomHint": `Scroll: zoom · drag: pan`,
    "chart.zoomReset": `Reset`,
    "chart.powerDurationAria": `Power-duration curve`,
    "chart.speedAria": `Speed curve`,
    "chart.strideAria": `Stride length`,
    "chart.weeklyDistAria": `Weekly distance by discipline`,
    "charts.chooseAria": `Choose which charts to display`,
    "coach.addAria": `Add a coach`,
    "coach.emailPh": `firstname@example.com`,
    "coach.rolePh": `E.g. Cycling, Running, Nutrition, Data…`,
    "cycle.createAria": `Create a cycle`,
    "cycle.durationAria": `Cycle duration`,
    "cycle.nameAria": `Cycle name`,
    "cycle.namePh": `Cycle name (e.g. Winter base, Race A taper…)`,
    "cycle.optionalPh": `Optional`,
    "cycle.weekPh": `e.g. week of June 23`,
    "display.optionsAria": `Display and color options`,
    "display.optionsTitle": `Display & colors`,
    "fitness.analysisAria": `Fitness analysis`,
    "gear.addAria": `Add gear`,
    "gear.freeTextPh": `Or type it in freely if it's not in the catalog`,
    "gear.modelPh": `E.g. Pegasus, Novablast, Vaporfly…`,
    "group.createAria": `Create a group`,
    "group.descPh": `E.g. Long-distance, Ironman format`,
    "group.namePh": `E.g. Adult Ironman Triathlon`,
    "invite.linkAria": `Invite link to share`,
    "lactate.bookAria": `Book a lactate test`,
    "license.medicalAria": `License and medical certificate`,
    "license.numberPh": `E.g. 1234567`,
    "mental.availableAria": `Available mental coaches`,
    "mental.bookingAria": `Book a mental coaching session`,
    "mental.calendlyTitle": `Booking calendar · mental coaching`,
    "mental.prepAria": `Mental coaching`,
    "message.aria": `Message`,
    "message.ph": `Write a message…`,
    "message.sendAria": `Send`,
    "messaging.aria": `Messaging`,
    "modal.closeAria": `Close`,
    "nav.athleteNav": `Athlete navigation`,
    "nav.displayMode": `Display mode`,
    "nav.help": `Help`,
    "nav.helpTitle": `Help & guide`,
    "nav.nextWeek": `Next week`,
    "nav.prevWeek": `Previous week`,
    "nav.weeksNav": `Week navigation`,
    "calendar.viewWeek": `Week`, "calendar.viewDay": `Day`, "calendar.viewAria": `Calendar view`,
    "notif.aria": `Notifications`, "notif.ariaWithCount": `Notifications ({n})`,
    "notif.athleteAlerts": `Athlete alerts`,
    "notif.title": `Alerts`,
    "parental.consentAria": `Parental consent`,
    "parental.emailPh": `parent@example.com`,
    "race.debriefAria": `Race debrief`,
    "race.feltPh": `How you felt during the race…`,
    "race.instructionsPh": `E.g. At 30 km, slow down if HR > 170. Aid station at km 15.`,
    "race.namePh": `E.g. Gorillaman Sprint`,
    "race.resultPh": `E.g. 1h12, or overall placing`,
    "race.weatherPh": `E.g. hot, rain, wind…`,
    "request.acceptAria": `Accept a request`,
    "session.analysisAria": `Session analysis`,
    "session.createAria": `Create a session`,
    "session.goalAria": `Session goal`,
    "session.goalTitle": `Session goal · used by the AI analysis`,
    "session.notePh": `Auto based on type · or write your own instructions`,
    "session.duringPh": `E.g. 60–80 g of carbs/h`,
    "session.nutritionPh": `E.g. protein within 30 min + carbs`,
    "session.sportAria": `Sport`,
    "session.titleAria": `Session title`,
    "session.titlePh": `Session title (e.g. Threshold 4×8' FTP)`,
    "settings.label": `Settings`,
    "share.relativesAria": `Share with family & friends`,
    "sidebar.panelAria": `Side panel`,
    "slot.coachNamePh": `Coach name`,
    "slot.createAria": `Create a time slot`,
    "slot.descPh": `E.g. 6×400m at 5K pace, 1' recovery + core work · visible to registrants`,
    "slot.placePh": `E.g. Stadium / Hyrox box`,
    "slot.sheetAria": `Time slot details`,
    "slot.titlePh": `E.g. Group track session`,
    "theme.changeAria": `Switch theme`,
    "theme.changeTitle": `Light / dark mode`,
    "today.pointAria": `Your daily check-in`,
    "tour.guidedAria": `Guided tour`,
    "tour.guidedTitle": `Guided tour · create a session`,
    "video.filterSportAria": `Filter by sport`,
    "video.gridTitle": `Show modular grid (Müller-Brockmann)`,
    "video.libraryAria": `Video library`,
    "video.playerAria": `Video player`,
    "video.searchAria": `Search a video`,
    "video.searchPh": `Search (catch-up, drills, squat…)`,
    "week.summaryAria": `Week summary`,
    "whatsapp.openTitle": `Open in WhatsApp`,
    ...
    "tour.welcome.title": `Welcome to Sillance!`,
    "tour.welcome.text": `Let's create your first session together · a run, with a warm-up, an effort interval, and a recovery.`,
    "tour.welcome.cta": `Let's go`,
    "tour.create.title": `Create a session`,
    "tour.create.text": `Click this button to open the session builder.`,
    "tour.sport.title": `Pick the sport`,
    "tour.sport.text": `Select "Running" for this demo.`,
    "tour.warmup.title": `Warm-up already set`,
    "tour.warmup.text": `A warm-up is added automatically to every session. You can adjust its duration or intensity here.`,
    "tour.warmup.cta": `Next`,
    "tour.addexo.title": `Add an exercise`,
    "tour.addexo.text": `Click to add an effort interval to this block.`,
    "tour.intensity.title": `Set the intensity`,
    "tour.intensity.text": `Choose an intensity zone for this effort · for example Threshold or vVO2max.`,
    "tour.recov.title": `Add a recovery`,
    "tour.recov.text": `Click to add a recovery after the effort.`,
    "tour.series.title": `Create intervals`,
    "tour.series.text": `Increase the number of sets to repeat this block several times: that's an interval. Try ×5.`,
    "tour.save.title": `Save the session`,
  ...
  var es = {
    "payReturn.titleSuccess": `Pago confirmado`,
    "payReturn.titleCancel": `Pago cancelado`,
    "payReturn.continue": `Continuar`,
    "payReturn.checkout.success": `Tu suscripción de Entrenador está activa. Bienvenido.`,
    "payReturn.checkout.cancel": `El pago fue cancelado, tu suscripción no ha cambiado.`,
    "payReturn.ai.success": `El Asistente IA está activado en tu cuenta.`,
    "payReturn.ai.cancel": `La activación del Asistente IA fue cancelada.`,
    "payReturn.coaching.success": `Tu suscripción de coaching está activa.`,
    "payReturn.coaching.cancel": `La suscripción de coaching no se activó.`,
    "payReturn.clubSub.success": `La suscripción del club a Sillance está activa.`,
    "payReturn.clubSub.cancel": `La suscripción del club no se activó.`,
    "payReturn.videos.success": `El acceso a los vídeos se actualizó para tus atletas.`,
    "payReturn.videos.cancel": `La actualización del acceso a los vídeos fue cancelada.`,
    "payReturn.creneau.success": `Tu plaza está reservada, el pago está confirmado.`,
    "payReturn.creneau.cancel": `La reserva no se confirmó, el pago fue cancelado.`,
    "payReturn.coachConnect.success": `Tu cuenta Stripe está vinculada. Ya puedes cobrar a tus atletas.`,
    "payReturn.coachConnect.cancel": `La vinculación con Stripe no ha terminado. Vuelve a intentarlo cuando quieras desde el banner "Cóbrales".`,
    "payReturn.clubConnect.success": `La cuenta Stripe del club está vinculada. Ya se pueden cobrar los pagos de los socios.`,
    "payReturn.clubConnect.cancel": `La vinculación con Stripe del club no ha terminado. Vuelve a intentarlo desde los ajustes de facturación.`,
    ...
    "toast.selfCoachEnabled": `Auto-coaching activado · cambia a la pestaña Atleta para gestionar tu entrenamiento.`,
    "toast.selfCoachError": `No se pudo activar el auto-coaching, inténtalo de nuevo.`,
    "toast.assistantIaActiveEssai14": `Asistente de IA activado · prueba de 14 días (demo)`,
    "toast.athleteNotifiedReady": `Se avisó a {name} de que su semana está lista`,
    ...
    "deviceReturn.connectedZero": `{provider} conectado.`,
    "deviceReturn.connectedSingular": `{provider} conectado, {n} actividad importada.`,
    "deviceReturn.connectedPlural": `{provider} conectado, {n} actividades importadas.`,
    "deviceReturn.error": `La conexión ha fallado. Vuelve a intentarlo desde la tarjeta Sincronización.`,
    ...
    "ready.recoveryReady": `Listo para un esfuerzo duro ahora`,
    "ready.recoveryIn": `Esfuerzo duro posible en {time}`,
    "ready.recoveryHours": `{h} h`, "ready.recoveryDays": `{d} d`, "ready.recoveryDaysHours": `{d} d {h} h`,
    "predict.heading": `Predictor de carrera`, "predict.sub": `estimado a partir del ritmo umbral y la forma actual`,
    "predict.half": `Media maratón`, "predict.marathon": `Maratón`,
    "mono.heading": `Monotonía & Strain`, "mono.sub": `variabilidad de la carga en 7 días (método Foster)`,
    "mono.high": `Alta`, "mono.ok": `Correcta`,
    "mono.strainNote": `Strain semanal ≈ {strain} · una monotonía alta (≥2) indica una carga estable sin recuperación real, aunque el ACWR parezca correcto.`,
    "block.heading": `Historial bloque a bloque`, "block.sub": `carga semanal media, periodos comparados`,
    "block.prev12": `12 sem. anteriores`, "block.last4": `Últimas 4 sem.`, "block.avgLoadWeek": `carga/sem.`,
    "dash.widgetsHeading": `Widgets visibles`, "dash.widgetsSub": `Elige qué aparece en tu barra lateral de coach y tu panel de forma.`,
    "dash.widgetNeedRadar": `Quién te necesita esta semana`, "dash.widgetPlanningRadar": `Recordatorio de planificación`,
    "dash.widgetReadyhub": `Estado de forma & riesgo`, "dash.widgetAdvanced": `Carga avanzada (predictor, monotonía, bloques)`,
    "dash.widgetNutritionToday": `Nutrición recomendada (punto del día) — usa tu consigna "durante el esfuerzo"`,
    "dash.alertsHeading": `Alertas personalizadas`, "dash.alertsSub": `Define tus propios umbrales: al superarse, el atleta sube en el radar "quién te necesita".`,
    "dash.noAlerts": `Aún no hay alertas personalizadas.`, "dash.threshold": `Umbral`,
    "dash.addAlert": `+ Añadir`, "dash.thresholdRequired": `Indica un umbral.`, "dash.alertAdded": `Alerta añadida.`,
    "clubFilter.allSports": `Todos los deportes`, "clubFilter.allGroups": `Todos los grupos`, "clubFilter.allLevels": `Todos los niveles`,
    "level.debutant": `Principiante`, "level.confirme": `Intermedio`, "level.competition": `Competición`,
    "season.title": `Calendario de temporada`, "season.btn": `Temporada`, "season.add": `+ Añadir`,
    "season.empty": `Aún no hay ninguna carrera registrada.`, "season.addResult": `+ añadir resultado`,
    "season.resultFor": `Resultado — {name}`, "season.fillNameDate": `Indica al menos el nombre y la fecha.`, "season.added": `Carrera añadida al calendario.`,
    "season.saveError": `No se pudo guardar la carrera, inténtalo de nuevo.`, "season.myRaces": `Mis carreras`, "season.openMine": `Ver mi calendario de temporada`,
    "compareAth.btn": `Comparar 2 atletas`, "compareAth.title": `Comparar dos atletas`,
    "compareAth.forme": `Forma (check-in)`, "compareAth.hrv": `HRV`, "compareAth.drop": `Desacoplamiento`, "compareAth.racedays": `Días para la carrera`,
    "compareAth.pickTwo": `Elige dos atletas diferentes para comparar.`, "compareAth.noData": `Aún no hay datos comparables para estos dos atletas.`,
    "recap.title": `Análisis de carrera`, "recap.typeRun": `Carrera a pie`, "recap.typeTri": `Triatlón`, "recap.typeHyrox": `Hyrox`,
    "recap.editLink": `Editar análisis`, "recap.addLink": `+ Análisis de carrera`,
    "recap.totalTime": `Tiempo total`, "recap.avgPace": `Ritmo medio`, "recap.avgHr": `FC media`,
    ...
    "recap.raceInfo": `Clasificación & condiciones`, "recap.rankScratch": `General`, "recap.rankTotal": `De`,
    "recap.rankCat": `Puesto cat.`, "recap.catLabel": `Categoría`, "recap.temp": `Temperatura (°C)`,
    "recap.wind": `Viento (km/h)`, "recap.dplusBike": `D+ bici (m)`, "recap.dplusRun": `D+ carrera (m)`,
    "recap.preRaceNutrition": `Antes de la carrera`, "recap.carbs": `Carbohidratos (g)`, "recap.liquid": `Líquido (L)`,
    "recap.note": `Nota`, "recap.notePh": `Sensación, tolerancia digestiva…`, "recap.pace100": `Ritmo /100m`,
    "recap.nutritionNote": `Nutrición`, "recap.hrMax": `FC máx`,
    "recap.editView": `Edición`, "recap.cockpitView": `Ficha`, "recap.compareTitle": `Comparador de carreras`,
    "recap.compareBtn": `Comparar con otra carrera`, "recap.dplusTotal": `D+ total`,
    "recap.noRankYet": `Añade la clasificación y las condiciones en la pestaña Edición para verlas aquí.`,
    "recap.zoneHr": `Tiempo en zona FC`, "recap.zonePower": `Tiempo en zona de potencia`,
    "recap.pickTwoRaces": `Elige dos carreras (con análisis completado) para comparar.`,
    "recap.cockpitTriOnly": `La ficha visual solo está disponible para carreras de triatlón por ahora.`,
    "recap.transitions": `Transiciones`, "common.vs": `vs`,
    ...
    "lineType.educatif": `Ejercicio técnico`,
    "nage.crawl": `Crol`, "nage.dos": `Espalda`, "nage.brasse": `Braza`, "nage.papillon": `Mariposa`,
    "nage.4n": `Estilos`, "nage.libre": `Libre / mixto`,
...
200m retour au calme`,
    ...
    "premium.error": `No se pudo abrir el pago`,
    "premium.unlocked": `{n} sesiones Sillance desbloqueadas`,
    ...
    "sidebar.accountMovedNote": `La suscripción, el asistente IA y los pagos ahora están en Ajustes (icono ⚙ arriba a la derecha).`,
    "sidebar.sillanceSub": `⭐ Suscripción Sillance`, "sidebar.subActive": `Suscripción activa`, "sidebar.manageSub": `Gestionar mi suscripción`,
    "sidebar.unlockCoach": `Desbloquea el espacio coach ilimitado.`, "sidebar.subscribe": `Suscribirse`, "sidebar.perMonth": `mes`, "sidebar.seePlans": `Ver los planes`,
    ...
    "sidebar.selfCoach": `Entrenarme también`, "sidebar.selfCoachText": `Añádete a tu propio roster: gestiona tu entrenamiento como un atleta normal (check-in, calendario, análisis). Cuenta en tu cuota de atletas.`,
    "sidebar.selfCoachBtn": `Activar`, "sidebar.selfCoachActive": `Auto-coaching activado · pestaña Atleta desbloqueada`,
    ...
    "sync.stravaPrivacy": `Tus datos de <b>Strava</b> siguen siendo personales (condiciones de Strava). Para compartirlos con tu coach: <b>Polar/Coros</b> o <b>importación de archivo</b>.`,
    "sync.readOnly": `Strava · Polar · Coros · datos de solo lectura`,
    ...
    "sync.stravaPrivacy2": `Las actividades de <b>Strava</b> siguen siendo personales del atleta (condiciones de Strava) y no se comparten con el coach. Canales compartibles: <b>Polar/Coros</b> o <b>importación .FIT/.TCX/.GPX</b>.`,
    "sync.poweredBy": `Con la tecnología de Strava · Polar · Coros`, "sync.seeDetailedAnalysis": `Ver el análisis detallado`,
    ...
    "checkin.sendFailed": `Error al enviar · comprueba tu conexión e inténtalo de nuevo`,
    "checkin.sentInjuryAlert": `Check-in enviado · se ha avisado a tu entrenador de tu lesión`,
    "checkin.sentPriorityAlert": `Check-in enviado · alerta prioritaria a tu entrenador`,
    "checkin.sentCoachNotified": `Check-in enviado · tu entrenador ha sido avisado`,
    "checkin.sent": `Check-in enviado`,
    "recordSeed.halfMarathon": `Media maratón`,
    "chart.swimTimesTen": `Natación ×10`,

    "need.injured": `Lesionado`, "need.sick": `Enfermo`, "need.tired": `Cansado`,
    "need.lowForm": `Forma baja ({pct}%)`, "need.lowHrv": `VFC baja`,
    "need.zonesToRetest": `Zonas por repetir ({days} d)`, "need.noCheckinToday": `Sin check-in hoy`,

    "planGap.title": `Atletas por planificar`,
    "planGap.h72": `H-72`, "planGap.h48": `H-48`, "planGap.h24": `H-24`,
    "planGap.allSet": `Todos tienen su semana · fecha límite {day}.`,
    "planGap.deadlineLabel": `Fecha límite`, "planGap.deadlineAria": `Día límite de la semana`,
    "weekDeadline.friday": `Viernes`, "weekDeadline.saturday": `Sábado`, "weekDeadline.sunday": `Domingo`,

    "guide.whereToStart": `Por dónde empezar`, "guide.subtitle": `4 pasos para lanzar tu coaching.`,
    "guide.step1Title": `Crea tus sesiones`, "guide.step1Text": `tu biblioteca, o un ciclo completo de una vez.`,
    "guide.step2Title": `Añade un atleta`, "guide.step2Text": `invítalo por email, verá su plan.`,
    "guide.step3Title": `Conecta su reloj`, "guide.step3Text": `Garmin, Coros o .FIT, sus sesiones se sincronizan analizadas.`,
    "guide.step4Title": `Planifica su semana`, "guide.step4Text": `arrastra tus sesiones al calendario.`,
    "guide.cta": `Crear mi primera sesión`,

    "invite.emailPh": `email@atleta.com`,
    "meta.appTitle": `Sillance · Coaching de triatlón`,

    "club.myClubFallback": `Mi club`,
    "auth.confirmLogOut": `¿Cerrar sesión?`,
    "auth.connected": `Conectado`,
    "auth.logIn": `Iniciar sesión`,
    "auth.logOut": `Cerrar sesión`,
    "auth.createAccount": `Crea tu cuenta`,
    "auth.logInToSpace": `Inicia sesión en tu espacio`,
    "auth.fullName": `Nombre completo`,
    "auth.fullNamePh": `Nombre Apellido`,
    "auth.iAm": `Soy…`,
    "auth.emailPh": `tu@mail.com`,
    "auth.password": `Contraseña`,
    "auth.consentText": `Acepto que Sillance procese mis datos de entrenamiento, incluidos mis datos de salud (check-ins, frecuencia cardíaca), para prestar el servicio. Consulta la`,
    "auth.privacyPolicyLink": `política de privacidad`,
    ...
    "auth.pleaseAcceptConsent": `Acepta el tratamiento de tus datos para crear tu cuenta.`,
    "auth.accountCreatedCheckEmail": `Cuenta creada. Revisa tu email y luego inicia sesión.`,
    "auth.connectionError": `Error de conexión.`,
    "auth.errInvalidCredentials": `Email o contraseña incorrectos.`,
    "auth.errUserExists": `Ya existe una cuenta con este email. Intenta iniciar sesión.`,
    "auth.errWeakPassword": `La contraseña debe tener al menos 8 caracteres.`,
    "auth.errEmailNotConfirmed": `Confirma tu email antes de iniciar sesión (revisa tu bandeja de entrada).`,
    "auth.errInvalidEmail": `Dirección de email no válida.`,
    "auth.errRateLimited": `Demasiados intentos. Vuelve a intentarlo en un momento.`,
    "gate.trialOverHeading": `Tu prueba gratuita ha terminado`,
    "gate.trialOverText": `Suscríbete a Sillance para seguir entrenando a tus atletas, planificando y analizando.`,
    "gate.perMonth": `/mes`,
    "gate.subscribeToSillance": `Suscribirse a Sillance`,
    "gate.lastDay": `último día`,
    "gate.daysLeft": `{n} días restantes`,
    "gate.freeTrial": `Prueba gratuita`,
    "gate.subscribePrice": `Suscribirse (29 €/mes)`,
    "gate.trialOverText2": `Elige la formula que corresponde al número de atletas que entrenas · el mismo Sillance en cada nivel.`,
    "gate.pickTier": `Elige tu formula`,
    "gate.tier1.cap": `1 a 10 atletas entrenados`,
    "gate.tier2.cap": `11 a 30 atletas entrenados`,
    "gate.tier3.cap": `31+ atletas entrenados`,
    "gate.includedTitle": `Incluido en todos los niveles`,
    "gate.included.f1": `Planificación y biblioteca de sesiones`,
    "gate.included.f2": `Carga, zonas personalizadas y PMC por atleta`,
    "gate.included.f3": `Análisis Hyrox nativo (biomecánica, wall balls)`,
    "gate.included.f4": `Licencias federativas (FFTri / FFC)`,
    "gate.included.f5": `Facturación de atletas integrada`,
    "gate.selecting": `Redirigiendo…`,
    "settings.adminTitle": `Cuenta moderadora`,
    "settings.adminText": `Acceso completo a Sillance, sin suscripción ni pago · uso interno.`,
    "fitImport.unreadableFit": `Archivo .FIT ilegible`,
    "fitImport.cannotReadFile": `No se pudo leer el archivo.`,
    "fitImport.readError": `Error de lectura`,
    "fitImport.notEnoughPoints": `No hay suficientes puntos GPS/sensor en el archivo.`,
    "fitImport.badFitSignature": `falta la firma .FIT (archivo corrupto o formato incorrecto)`,
    "fitImport.bikeRide": `Salida en bici`,
    "fitImport.activityFallback": `Actividad`,
    ...
    "feel.skip": `Más tarde — responderé en mi próxima conexión`,
    ...
    "coachBand.notifyReady": `Avisar a {name} de que su semana está lista`,
    ...
    "clubSub.terms": `Suscripción mensual, prueba gratuita de 14 días y luego un cobro cada mes. Compromiso mínimo de 3 meses, cancelable en cualquier momento después.`,
    "clubSub.choosePlan": `Elegir el plan {name}`,
    "clubSub.planChosenToast": `Plan {name} elegido · {p} €/mes{founder}. Prueba gratuita de 14 días antes del primer cobro.`,
    ...
    "video.placeholder": `Vídeo muy pronto`,
    "video.placeholderHint": `¿Preguntas? Contacta al soporte: contact@sillance.app`,
    ...
    "today.recommendedNutrition": `Nutrición recomendada`,
    ...
    "nav.trainingPlan": `Plan de entrenamiento`,
    "mode.coach": `Entrenador`,
    "mode.athlete": `Atleta`,
    "mode.club": `Club`,
    "a11y.colorVisionHeading": `Visión de los colores`,
    "a11y.stdColors": `Colores estándar`,
    "a11y.deuteranopia": `Deuteranopía`,
    "a11y.protanopia": `Protanopía`,
    "a11y.tritanopia": `Tritanopía`,
    "a11y.redGreen": `(rojo-verde)`,
    "a11y.blueYellow": `(azul-amarillo)`,
    "a11y.aidsHeading": `Ayudas`,
    "a11y.patternsOption": `Patrones en las disciplinas`,
    "a11y.highContrastOption": `Contraste reforzado`,
    "nav.home": `Inicio`,
    "nav.forme": `Forma & carreras`,
    "nav.calendrier": `Calendario`,
    "nav.stats": `Estadísticas`,
    "nav.outils": `Herramientas`,
    "dash.nextRace": `Próxima carrera`,
    "dash.weekLoad": `Carga semanal`,
    "dash.plannedVolume": `Volumen planificado`,
    "dash.freshnessRising": `Frescura en aumento`,
    "dash.completed": `Realizado`,
    "perf.analysisBannerTitle": `Análisis de la sesión y del rendimiento`,
    "perf.collapse": `Plegar`,
    "perf.aiAssisted": `Análisis asistido`,
    "fitness.stateHeading": `Estado de forma`,
    "fitness.riskSuffix": `y riesgo`,
    "fitness.whatAnalysisLooksAt": `Qué observa el análisis`,
    "perf.analysisHeading": `Análisis`,
    "perf.performanceSuffix": `rendimiento`,
    "stats.showDetailed": `Mostrar mis estadísticas detalladas`,
    "stats.showDetailedHint": `Desmarca si es demasiada información · puedes volver a activarlo cuando quieras.`,
    "chart.cumulLoadHeading": `Carga acumulada y señales`,
    "chart.cumulLoadSub": `· durante todo el año del calendario`,
    "chart.loadFitnessHeading": `Carga y forma`,
    "chart.loadFitnessSub": `· cursor sincronizado con FTP y distancia`,
    "chart.optimalFormZone": `Zona de forma óptima`,
    "chart.weeklyDistHeading": `Distancia semanal`,
    "chart.lactateLabel": `Lactato`,
    "chart.durabilityHeading": `Durabilidad`,
    "chart.durabilitySub": `· potencia bajo fatiga`,
    "chart.raceDynamicsHeading": `Dinámicas de carrera`,
    "chart.raceDynamicsSub": `· zonas`,
    "chart.strideOutputHeading": `Zancada y potencia`,
    "chart.cadenceGctHeading": `Tendencia de cadencia y contacto con el suelo`,
    "chart.trainingLoadHeading": `Carga de entrenamiento`,
    "chart.trainingLoadSub": `· método`,
    "records.heading": `Récords`,
    "records.personalSuffix": `personales`,
    "records.runPaceTab": `Ritmo de carrera`,
    "video.eyebrow": `Técnica`,
    "video.libraryHeading": `Biblioteca`,
    "video.librarySuffix": `de vídeo`,
    "video.soonTitle": `Muy pronto`,
    "video.soonText": `La biblioteca de vídeos técnicos está en rodaje.`,
    "video.soonContact": `¿Alguna pregunta? Escribe al soporte: <a href="mailto:contact@sillance.app">contact@sillance.app</a>`,
    "mental.includedTag": `Incluido en tu plan de coaching`,
    "lactate.knowThresholdsTag": `Conoce tus verdaderos umbrales`,
    "lactate.bookHeading": `Reserva tu test de lactato`,
    "lactate.bookMyTest": `Reservar mi test`,
    "club.eyebrow": `Espacio club`,
    "club.tabDash": `Panel`,
    "club.tabSlots": `Horarios`,
    "club.tabAttendance": `Asistencia`,
    "club.tabBilling": `Facturación`,
    "club.tabMembers": `Socios`,
    "club.tabGroups": `Grupos`,
    "club.tabOffers": `Ofertas`,
    "club.inviteLinkTitle": `Enlace de invitación del club`,
    "common.copy": `Copiar`,
    "slot.newBadge": `Nuevo horario`,
    "slot.groupHeading": `Horario colectivo`,
    "slot.disciplineLabel": `Disciplina`,
    "slot.dayLabel": `Día`,
    "slot.timeLabel": `Hora`,
    "slot.titleLabel": `Título`,
    "slot.durationLabel": `Duración (min)`,
    "slot.placeLabel": `Lugar`,
    "slot.capacityLabel": `Plazas máx.`,
    "slot.contentLabel": `Contenido de la sesión`,
    "slot.groupRestrictedLabel": `Grupo (contenido restringido)`,
    "slot.wholeClubOption": `Todo el club`,
    "slot.badge": `Horario`,
    "slot.descTab": `Descripción`,
    "slot.participantsTab": `Participantes`,
    "group.newBadge": `Nuevo grupo`,
    "group.nameLabel": `Nombre del grupo`,
    "group.descLabel": `Descripción (opcional)`,
    "group.colorLabel": `Color`,
    "group.membersLabel": `Atletas del grupo`,
    "parental.athleteIsPrefix": `Este atleta es`,
    "parental.minorWord": `menor de edad`,
    "parental.under18": `(menos de 18 años)`,
    "parental.guardianNameLabel": `Nombre del representante legal`,
    "license.federationLabel": `Federación`,
    "license.validUntilLabel": `Certificado médico válido hasta`,
    "athlete.backgroundLabel": `Trayectoria deportiva`,
    "records.personalLabel": `Récords personales`,
    "athlete.injuryHistoryLabel": `Historial de lesiones`,
    "athlete.dietLabel": `Hábitos alimentarios`,
    "race.debriefsLabel": `Debriefs de carrera (rellenados por el atleta)`,
    "race.debriefsHeading": `Debriefs de carrera`,
    "coach.teamLabel": `Equipo de entrenadores`,
    "coach.proposeAdditional": `Proponer un entrenador adicional`,
    "coach.emailLabel": `Email del entrenador`,
    "coach.roleOptionalLabel": `Rol (opcional)`,
    "share.spectatorNoteLabel": `Notas para tus allegados (opcional)`,
    "race.debriefHeading": `¿Cómo fue tu carrera?`,
    "race.nameLabel": `Carrera`,
    "common.date": `Fecha`,
    "race.resultLabel": `Sensación general`,
    "race.nutritionFollowedLabel": `¿Nutrición seguida según lo previsto?`,
    "common.yes": `Sí`,
    "common.partially": `Parcialmente`,
    "common.no": `No`,
    "race.weatherLabel": `Clima`,
    "race.whatWentWellLabel": `Lo que funcionó bien`,
    "race.whatDidntLabel": `Lo que falló`,
    "request.acceptAthleteHeading": `Aceptar al atleta`,
    "request.assignGroupLabel": `Asignar a un grupo`,
    "gear.newHeading": `Nuevo equipamiento`,
    "gear.typeLabel": `Tipo`,
    "gear.runningShoesOption": `Zapatillas de correr`,
    "gear.searchModelLabel": `Busca tu modelo`,
    "gear.kmDoneLabel": `Km ya recorridos`,
    "gear.lifespanLabel": `Vida útil (km)`,
    "mental.chooseCoachThenSlot": `Elige tu preparador y luego tu horario.`,
    "common.fullName": `Nombre completo`,
    "common.email": `Email`,
    "lactate.testTypeLabel": `Tipo de test`,
    "common.both": `Ambos`,
    "lactate.periodLabel": `Período preferido`,
    "common.sendRequest": `Enviar mi solicitud`,
    "chart.speedHeading": `Velocidad`,
    "chart.hrHeading": `Frecuencia cardíaca`,
    "perf.conditionsImpactHeading": `Impacto de las condiciones`,
    "perf.conditionsImpactHint": `lo que te costó el entorno`,
    "perf.biomechanicsHeading": `Biomecánica`,
    "perf.biomechanicsHint": `dinámicas de carrera, si el reloj las proporciona`,
    "chart.cadenceHeading": `Cadencia`,
    "chart.strideLenHeading": `Longitud de zancada`,
    "chart.decouplingHeading": `Desacoplamiento`,
    "chart.decouplingHint": `eficiencia cardíaca a lo largo del tiempo`,
    "perf.lapDetailHeading": `Detalle por vuelta`,
    "perf.similarSessionsHeading": `Sesiones similares`,
    "perf.autoComparison": `comparación automática`,
    "cycle.newBadge": `Nuevo ciclo`,
    "cycle.startWeekLabel": `Semana de inicio:`,
    "session.newBadge": `Nueva sesión`,
    "session.goalAutoOption": `Objetivo: auto`,
    "session.refsShownLabel": `Referencias mostradas:`,
    "session.beforeSessionLabel": `Antes de la sesión`,
    "session.duringSessionLabel": `Durante el esfuerzo`,
    "session.afterSessionLabel": `Después de la sesión (recuperación)`,
    "common.clickToEnlarge": `Clic para ampliar`,

    "a11y.optionsAria": `Opciones de accesibilidad`,
    "athlete.allergiesPh": `Alergias, dieta, preferencias…`,
    "athlete.experiencePh": `Desde cuándo practica, experiencia, contexto…`,
    "athlete.namePh": `Ej. Claire Rousseau`,
    "athlete.schedulePh": `Horarios, trabajo físico o sedentario, restricciones…`,
    "athlete.searchAria": `Buscar un atleta`,
    "athlete.searchPh": `Buscar un atleta…`,
    "athlete.sheetAria": `Ficha del atleta`,
    "athlete.trackedAria": `Atleta seguido`,
    "athlete.weightPh": `Ej. 58`,
    "calendar.trainingAria": `Calendario de entrenamiento`,
    "chart.altitudeAria": `Perfil de altitud`,
    "chart.cadenceAria": `Cadencia`,
    "chart.cadenceGctAria": `Tendencia de cadencia y tiempo de contacto con el suelo`,
    "chart.decouplingAria": `Curva de desacoplamiento`,
    "chart.durabilityAria": `Curva de durabilidad`,
    "chart.ftpPmaAria": `Evolución de FTP y PMA`,
    "chart.hrCurveAria": `Curva de frecuencia cardíaca`,
    "chart.hrZonesAria": `Distribución de zonas cardíacas`,
    "chart.lactateAria": `Curva de lactato en bici`,
    "chart.loadAria": `Carga acumulada por disciplina, fatiga, riesgo de lesión y forma`,
    "chart.loadFitnessAria": `Evolución de la carga y la forma`,
    "chart.powerAria": `Curva de potencia`,
    "chart.clickToZoom": `clic para ampliar`,
    "chart.zoomAria": `Detalle del gráfico`,
    "chart.zoomChartAria": `Gráfico detallado y ampliable`,
    "chart.zoomHint": `Rueda: zoom · arrastrar: desplazar`,
    "chart.zoomReset": `Restablecer`,
    "chart.powerDurationAria": `Curva potencia-duración`,
    "chart.speedAria": `Curva de velocidad`,
    "chart.strideAria": `Longitud de zancada`,
    "chart.weeklyDistAria": `Distancia semanal por disciplina`,
    "charts.chooseAria": `Elegir los gráficos a mostrar`,
    "coach.addAria": `Añadir un entrenador`,
    "coach.emailPh": `nombre@ejemplo.com`,
    "coach.rolePh": `Ej. Ciclismo, Carrera, Nutrición, Datos…`,
    "cycle.createAria": `Crear un ciclo`,
    "cycle.durationAria": `Duración del ciclo`,
    "cycle.nameAria": `Nombre del ciclo`,
    "cycle.namePh": `Nombre del ciclo (ej. Base invierno, Afinado carrera A…)`,
    "cycle.optionalPh": `Opcional`,
    "cycle.weekPh": `ej. semana del 23 de junio`,
    "display.optionsAria": `Opciones de visualización y colores`,
    "display.optionsTitle": `Visualización y colores`,
    "fitness.analysisAria": `Análisis del estado de forma`,
    "gear.addAria": `Añadir equipamiento`,
    "gear.freeTextPh": `O escríbelo libremente si no está en el catálogo`,
    "gear.modelPh": `Ej. Pegasus, Novablast, Vaporfly…`,
    "group.createAria": `Crear un grupo`,
    "group.descPh": `Ej. Larga distancia, formato Ironman`,
    "group.namePh": `Ej. Triatlón Ironman adultos`,
    "invite.linkAria": `Enlace de invitación para compartir`,
    "lactate.bookAria": `Reservar un test de lactato`,
    "license.medicalAria": `Licencia y certificado médico`,
    "license.numberPh": `Ej. 1234567`,
    "mental.availableAria": `Preparadores mentales disponibles`,
    "mental.bookingAria": `Reserva de preparación mental`,
    "mental.calendlyTitle": `Agenda de reservas · preparación mental`,
    "mental.prepAria": `Preparación mental`,
    "message.aria": `Mensaje`,
    "message.ph": `Escribe un mensaje…`,
    "message.sendAria": `Enviar`,
    "messaging.aria": `Mensajería`,
    "modal.closeAria": `Cerrar`,
    "nav.athleteNav": `Navegación del atleta`,
    "nav.displayMode": `Modo de visualización`,
    "nav.help": `Ayuda`,
    "nav.helpTitle": `Ayuda y guía`,
    "nav.nextWeek": `Semana siguiente`,
    "nav.prevWeek": `Semana anterior`,
    "nav.weeksNav": `Navegación de semanas`,
    "calendar.viewWeek": `Semana`, "calendar.viewDay": `Día`, "calendar.viewAria": `Vista del calendario`,
    "notif.aria": `Notificaciones`, "notif.ariaWithCount": `Notificaciones ({n})`,
    "notif.athleteAlerts": `Alertas de atletas`,
    "notif.title": `Alertas`,
    "parental.consentAria": `Consentimiento parental`,
    "parental.emailPh": `padre@ejemplo.com`,
    "race.debriefAria": `Debrief de carrera`,
    "race.feltPh": `Cómo te sentiste durante la carrera…`,
    "race.instructionsPh": `Ej. A los 30 km, reduce si FC > 170. Avituallamiento en el km 15.`,
    "race.namePh": `Ej. Gorillaman Sprint`,
    "race.resultPh": `Ej. 1h12, o posición en la general`,
    "race.weatherPh": `Ej. calor, lluvia, viento…`,
    "request.acceptAria": `Aceptar una solicitud`,
    "session.analysisAria": `Análisis de la sesión`,
    "session.createAria": `Creación de sesión`,
    "session.goalAria": `Objetivo de la sesión`,
    "session.goalTitle": `Objetivo de la sesión · usado por el análisis de IA`,
    "session.notePh": `Automático según el tipo · o escribe tu propia consigna`,
    "session.duringPh": `Ej. 60–80 g de carbohidratos/h`,
    "session.nutritionPh": `Ej. proteínas en los primeros 30 min + carbohidratos`,
    "session.sportAria": `Deporte`,
    "session.titleAria": `Título de la sesión`,
    "session.titlePh": `Título de la sesión (ej. Umbral 4×8' FTP)`,
    "settings.label": `Ajustes`,
    "share.relativesAria": `Compartir con tus allegados`,
    "sidebar.panelAria": `Panel lateral`,
    "slot.coachNamePh": `Nombre del entrenador`,
    "slot.createAria": `Crear un horario`,
    "slot.descPh": `Ej. 6×400m a ritmo de 5K, recuperación 1' + core · visible para los inscritos`,
    "slot.placePh": `Ej. Estadio / Box Hyrox`,
    "slot.sheetAria": `Ficha del horario`,
    "slot.titlePh": `Ej. Sesión de pista colectiva`,
    "theme.changeAria": `Cambiar tema`,
    "theme.changeTitle": `Modo claro / oscuro`,
    "today.pointAria": `Tu check-in del día`,
    "tour.guidedAria": `Tutorial guiado`,
    "tour.guidedTitle": `Tutorial guiado · crear una sesión`,
    "video.filterSportAria": `Filtrar por deporte`,
    "video.gridTitle": `Mostrar cuadrícula modular (Müller-Brockmann)`,
    "video.libraryAria": `Biblioteca de vídeo`,
    "video.playerAria": `Reproductor de vídeo`,
    "video.searchAria": `Buscar un vídeo`,
    "video.searchPh": `Buscar (recuperación, series técnicas, sentadilla…)`,
    "week.summaryAria": `Resumen de la semana`,
    "whatsapp.openTitle": `Abrir en WhatsApp`,
    ...
    "tour.welcome.title": `¡Bienvenido a Sillance!`,
    "tour.welcome.text": `Vamos a crear tu primera sesión juntos · una sesión de carrera, con calentamiento, un intervalo de esfuerzo y una recuperación.`,
    "tour.welcome.cta": `Empezar`,
    "tour.create.title": `Crear una sesión`,
    "tour.create.text": `Haz clic en este botón para abrir el creador de sesiones.`,
    "tour.sport.title": `Elige el deporte`,
    "tour.sport.text": `Selecciona «Carrera a pie» para esta demo.`,
    "tour.warmup.title": `Calentamiento ya listo`,
    "tour.warmup.text": `Se añade automáticamente un calentamiento a cada sesión. Puedes ajustar su duración o intensidad aquí.`,
    "tour.warmup.cta": `Siguiente`,
    "tour.addexo.title": `Añade un ejercicio`,
    "tour.addexo.text": `Haz clic para añadir un intervalo de esfuerzo a este bloque.`,
    "tour.intensity.title": `Ajusta la intensidad`,
    "tour.intensity.text": `Elige una zona de intensidad para este esfuerzo · por ejemplo Umbral o VAM.`,
    "tour.recov.title": `Añade una recuperación`,
    "tour.recov.text": `Haz clic para añadir una recuperación después del esfuerzo.`,
    "tour.series.title": `Crea intervalos`,
    "tour.series.text": `Aumenta el número de series para repetir este bloque varias veces: eso es un intervalo. Prueba ×5.`,
    "tour.save.title": `Guarda la sesión`,
